...
class Network():
    ...
    def __init__(self, layers, mini_batch_size):
        ...
        self.v = [v for layer in self.layers for v in layer.v ]
        self.u = T.fscalar('u')
        self.x = T.matrix("x")
        self.y = T.ivector("y")
    ...
    def SGD(self, training_data, epochs, mini_batch_size, eta,
        ...
        updates1 = [(v, self.u * v - eta*grad)
                   for v, grad in zip(self.v, grads)]

        updates2 = [(param, param+v)
        ...
        train_mb = theano.function(
            [i,self.u], cost, updates=updates1,
            givens={
                self.x:
